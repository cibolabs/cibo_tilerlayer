...
IN_FILE = '/vsis3/cibo-test-oregon/cibo_tilerlayer/median_tsdm_aus_20240129_wm_r80m_v2.vrt'
TEST_Z = 7
TEST_X = 115
TEST_Y = 74
...
def doColorMapTest():
    ...
    tile = cibotiling.getTile(IN_FILE, TEST_Z, TEST_X, TEST_Y, bands=[1], 
        colormap=colormap, logger=logger)
